...
export default class bitvavo extends Exchange {
    ...
    currencyToPrecision (code: string, fee: number, networkCode: Str = undefined) {        return this.decimalToPrecision (fee, 0, this.currencies[code]['precision'], DECIMAL_PLACES);
    }
